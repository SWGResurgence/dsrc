...
final public class menu_info implements Serializable
{
     ...
     *
     * @param name
     *         the canonical name of this menu.  This string is used to indicate the appropriate processing when the menu item is selected.
     * @param label
     *         the label to display on this menu
    ...
    private boolean validateData(menu_info_data data, boolean forInsert)
    {
        ...
        {
            System.out.println("Attempt to set a menu item {" + data + "} with an invalid parent.");
            debugDump();
            return false;
        }
        ...
        {
            System.out.println("Attempt to insert duplicate menu id keys {" + data + "}");
            debugDump();
            return false;
        }
        ...
        {
            System.out.println("Menu type out of range: {" + data + "}");
            return false;
        }
        ...
        {
            System.out.println("Menu inserted submenu with no valid parent. {" + data + "}");
            debugDump();
            return false;
        }
    ...
    private boolean setMenuItemsInternal(menu_info_data[] info_data)
    {
        ...
        for (final menu_info_data data : info_data)
        {
            ...
            {
                System.out.println("setMenuItemsInternal failed for " + data);
                m_vector.clear();
                m_nextId = 1;
                return false;
            }
