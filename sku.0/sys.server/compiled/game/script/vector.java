...
public final class vector implements Comparable, Serializable
{
     ...
     * @param t
     *         the time for the interpolation, from 0.0 (begin) to 1.0 (end)
     ...
     *
     * @param halfSideLength
     *         half the length of a side of the cube
     ...
     * @param line1
     *         another reference point on the line
     ...
     *
     * @param startPoint
     *         one endpoint of the frustum
     * @param endPoint
     *         the other endpoint of the frustum
     * @param startRadius
     *         the radius of the frustum at startPoint
     * @param endRadius
     *         the radius of the frustum at endPoint
     ...
     *         The tip of the cone
     * @param endPoint
     *         A point along the cone axis
     * @param range
     *         The max distance allowed
     * @param halfAngle
     *         The allowed angle from the axis to be in the cone
     ...
     *
     * @param vec
     *         vector to compute the dot product against.
     ...
     *
     * @param vec
     *         the vector to compare this against
     * @param epsilon
     ...
     *
     * @param incident
     *         Normal to reflect this vector around
     ...
     *
     * @param rhs
     *         the vector to subtract to this
     ...
     *
     * @param scalar
     *         the scalar value to multiply this by
     ...
     *
     * @param scalar
     *         the scalar value to divide this by
