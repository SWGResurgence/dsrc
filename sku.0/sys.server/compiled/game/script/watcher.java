...
class watcher extends Thread
{
    ...
    private final int m_warnTime;                // time a script is allowed to run before a warning is generated
    private final int m_interruptTime;            // time a script is allowed to run before it is interrupted
    private int m_state;
    private final Thread m_scriptThread;            // thread the scripts are running from
    private final Stack m_scripts;                // scripts being run
    private final Stack m_methods;                // methods being run
     ...
     *
     * @param warnMs
     *         time a script is allowed to run before a warning is generated
     * @param interruptMs
     *         time a script is allowed to run before it is interrupted
     */
