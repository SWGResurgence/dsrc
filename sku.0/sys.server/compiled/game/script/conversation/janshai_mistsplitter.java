...
// ----------------------------------------------------------------------
    ...
    {
        faceTo(npc, player);
        return groundquests.isTaskActive(player, "quest/world_boss_tatooine_krayt", "returnJanshaiMistsplitter");
    }
// ----------------------------------------------------------------------

    public boolean janshai_mistsplitter_condition_isOnQuest(obj_id player, obj_id npc) throws InterruptedException
    {
        return groundquests.isQuestActive(player, "quest/world_boss_tatooine_krayt");
    }
