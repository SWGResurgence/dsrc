...
// ----------------------------------------------------------------------
    ...
    {
        return groundquests.isQuestActive(player, "quest/wod_scouting_for_salvage");
    }
...
// ----------------------------------------------------------------------
    ...
    {
        faceTo(npc, player);
        return groundquests.isTaskActive(player, "quest/wod_scouting_for_salvage", "returnPrisonHeadGuardOne");
...
// ----------------------------------------------------------------------
    ...
    {
        faceTo(npc, player);
        return groundquests.hasCompletedQuest(player, "quest/wod_scouting_for_salvage");
    }
...
// ----------------------------------------------------------------------
    ...
    {
        faceTo(npc, player);
        return groundquests.hasCompletedQuest(player, "quest/wod_scouting_for_salvage") && groundquests.isQuestActive(player, "quest/wod_seeking_the_spellweavers_two");
    }
...
// ----------------------------------------------------------------------
    ...
    {
        return groundquests.isQuestActive(player, "quest/wod_striking_back_at_the_nightsisters");
    }
...
// ----------------------------------------------------------------------
    ...
    {
        faceTo(npc, player);
        return groundquests.hasCompletedQuest(player, "quest/wod_striking_back_at_the_nightsisters");
    }
...
// ----------------------------------------------------------------------
    ...
    {
        faceTo(npc, player);
        return groundquests.isTaskActive(player, "quest/wod_striking_back_at_the_nightsisters", "returnPrisonHeadGuardTwo");
