...
public class restuss_imperial_comms_vendor extends script.base_script {
    ...
    public int restuss_imperial_reward_npc_handleBranch1(obj_id self, obj_id player, string_id response) throws InterruptedException {
        if (response.equals("RestussImperialComms_2")) {
            restuss_imperial_reward_npc_action_showTokenVendorUI(player, self);
    ...
    public int OnNpcConversationResponse(obj_id self, String conversationId, obj_id player, string_id response) throws InterruptedException {
        ...
        if (restuss_imperial_reward_npc_handleBranch1(self, player, response) == SCRIPT_CONTINUE) {
            return SCRIPT_CONTINUE;
        }
