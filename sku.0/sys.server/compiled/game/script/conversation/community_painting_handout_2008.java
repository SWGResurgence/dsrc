...
public class community_painting_handout_2008 extends script.base_script
{
    ...
    {
        return hasCompletedCollectionSlot(player, "received_rebel_contest_painting");
    }
    ...
    {
        return hasCompletedCollectionSlot(player, "received_imperial_contest_painting");
    }
    ...
    public boolean community_painting_handout_2008_condition_hasReceivedBothPaintings(obj_id player, obj_id npc) throws InterruptedException
    {
        ...
        return !hasCompletedCollection(player, "player_received_contest_painting_tracker") && myAge >= 10;
    }
    ...
    {
        return !hasCompletedCollectionSlot(player, "received_rebel_contest_painting") && !hasCompletedCollectionSlot(player, "received_imperial_contest_painting");
    }
    ...
    {
        return hasCompletedCollection(player, "player_received_contest_painting_tracker");
    }
