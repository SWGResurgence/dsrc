...
public class restuss_rebel_commendation_vendor extends script.base_script {
    ...
    public void restuss_rebel_comms_vendor_action_showTokenVendorUI(obj_id player, obj_id npc) throws InterruptedException {
    ...
    public int OnNpcConversationResponse(obj_id self, String conversationId, obj_id player, string_id response) throws InterruptedException {
        if (!conversationId.equals("restuss_rebel_comms_vendor")) {
            return SCRIPT_CONTINUE;
        }
        if (restuss_rebel_comms_vendor_handleBranch1(self, player, response) == SCRIPT_CONTINUE) {
            return SCRIPT_CONTINUE;
        }
