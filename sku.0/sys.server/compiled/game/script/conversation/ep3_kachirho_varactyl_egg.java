...
public class ep3_kachirho_varactyl_egg extends script.base_script
{
    ...
    {
        return groundquests.isQuestActive(player, "ep3_kachirho_varactyl_egg");
    }
    ...
    {
        return features.hasEpisode3PreOrderDigitalDownload(player) && hasSkill(player, "outdoors_creaturehandler_master");
    }
