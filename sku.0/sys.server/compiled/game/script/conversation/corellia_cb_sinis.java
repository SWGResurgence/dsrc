...
public class corellia_cb_sinis extends script.base_script
{
    ...
    public boolean corellia_cb_sinis_condition_offerPart2(obj_id player, obj_id npc) throws InterruptedException
    {
        ...
        {
            return !groundquests.isQuestActive(player, "quest/corellia_cb_2_pointer") && !groundquests.isQuestActiveOrComplete(player, "quest/corellia_cb_2");
        }
        return false;
    }
    ...
    {
        return groundquests.hasCompletedQuest(player, "quest/corellia_cb_1") && groundquests.isQuestActiveOrComplete(player, "quest/corellia_cb_2");
    }
