...
public class ep3_forest_meust extends script.base_script
{
    ...
    {
        return groundquests.isTaskActive(player, "ep3_forest_meust_quest_1", 0) || groundquests.hasCompletedTask(player, "ep3_forest_meust_quest_1", 0);
    }
    ...
    {
        return groundquests.isTaskActive(player, "ep3_forest_meust_quest_2", 0) || groundquests.hasCompletedTask(player, "ep3_forest_meust_quest_2", 0);
    }
    ...
    {
        return groundquests.isTaskActive(player, "ep3_forest_meust_quest_3", 0) || groundquests.hasCompletedTask(player, "ep3_forest_meust_quest_3", 0);
    }
