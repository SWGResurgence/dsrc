...
public class chef_vendor extends script.base_script {
    ...
    public int OnStartNpcConversation(obj_id self, obj_id player) throws InterruptedException {
        ...
        if (chef_vendor_condition__defaultCondition(player, self)) {
            ...
            npcStartConversation(player, self, "chef_vendor", null, pp, new string_id[]{new string_id(c_stringFile, "s_2")});
            return SCRIPT_CONTINUE;
        }
    ...
    public int OnNpcConversationResponse(obj_id self, String conversationId, obj_id player, string_id response) throws InterruptedException {
        ...
        utils.removeScriptVar(player, "conversation.chef_vendor.branchId");
        return SCRIPT_CONTINUE;
    }
}
