...
// ----------------------------------------------------------------------
    ...
    {
        faceTo(npc, player);
        return groundquests.isTaskActive(player, "quest/wod_distorted_visions", "collectMidranaPlant");
...
// ----------------------------------------------------------------------
    ...
    {
        faceTo(npc, player);
        return groundquests.isQuestActive(player, "quest/wod_gathering_pieces_one");
    }
...
// ----------------------------------------------------------------------
    ...
    {
        faceTo(npc, player);
        return groundquests.isTaskActive(player, "quest/wod_gathering_pieces_one", "returnDrislynOne");
...
// ----------------------------------------------------------------------
    ...
    {
        faceTo(npc, player);
        return groundquests.hasCompletedQuest(player, "quest/quest/wod_gathering_pieces_one");
    }
...
// ----------------------------------------------------------------------
    ...
    {
        faceTo(npc, player);
        return groundquests.isQuestActive(player, "quest/wod_gathering_pieces_two");
    }
...
// ----------------------------------------------------------------------
    ...
    {
        faceTo(npc, player);
        return groundquests.isTaskActive(player, "quest/wod_gathering_pieces_two", "returnDrislynTwo");
...
// ----------------------------------------------------------------------
    ...
    {
        faceTo(npc, player);
        return groundquests.hasCompletedQuest(player, "quest/wod_gathering_pieces_two") && groundquests.isTaskActive(player, "quest/wod_distorted_visions", "collectMidranaPlant");
...
// ----------------------------------------------------------------------
    ...
    {
        faceTo(npc, player);
        return groundquests.hasCompletedQuest(player, "quest/wod_gathering_pieces_two") && groundquests.isTaskActive(player, "quest/wod_distorted_visions", "returnMerillaOne");
...
// ----------------------------------------------------------------------
    ...
    {
        faceTo(npc, player);
        return groundquests.hasCompletedQuest(player, "quest/wod_gathering_pieces_two") && groundquests.hasCompletedQuest(player, "quest/wod_distorted_visions");
