...
public class coronet_captain_dool extends script.base_script
{
    ...
    {
        return groundquests.isTaskActive(player, "quest/coronet_sheelya_commanding_officer", "goSeeDool") || groundquests.hasCompletedTask(player, "quest/coronet_sheelya_commanding_officer", "goSeeDool");
    }
    ...
    {
        return groundquests.isTaskActive(player, "quest/coronet_captain_dool", "returnToCaptain") || groundquests.hasCompletedTask(player, "quest/coronet_captain_dool", "returnToCaptain");
    }
    ...
    {
        return groundquests.hasCompletedQuest(player, "quest/coronet_captain_dool") && !groundquests.isQuestActive(player, "quest/tyrena_goto_lyman_zavala");
    }
