...
public class wod_ns_guide extends script.base_script
{
    ...
    {
        return (hasObjVar(player, "wod_prologue_quests")) && (groundquests.isTaskActive(player, "wod_rubina_goto_ns", "arrived") || groundquests.hasCompletedQuest(player, "wod_rubina_goto_ns"));
    }
