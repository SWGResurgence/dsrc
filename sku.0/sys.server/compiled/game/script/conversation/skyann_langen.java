...
// ----------------------------------------------------------------------
    ...
    {
        faceTo(npc, player);
        return groundquests.isTaskActive(player, "quest/world_boss_naboo_peko", "returnSkyannLangen");
    }
// ----------------------------------------------------------------------

    public boolean skyann_langen_condition_isOnQuest(obj_id player, obj_id npc) throws InterruptedException
    {
        return groundquests.isQuestActive(player, "quest/world_boss_naboo_peko");
    }
