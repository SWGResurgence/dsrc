...
// ----------------------------------------------------------------------
	...
	{
        faceTo(npc, player);
        if (groundquests.isTaskActive(player, "quest/world_boss_naboo_emperors_hand", "returnAnaFox"))
        {
            return true;
        }
        return false;
...
// ----------------------------------------------------------------------
	...
	{
        if (groundquests.isQuestActive(player, "quest/world_boss_naboo_emperors_hand"))
        {
            return true;
        }
        return false;
