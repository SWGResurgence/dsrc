...
public class ep3_mining_thom_steele extends script.base_script
{
    ...
    public boolean ep3_mining_thom_steele_condition_hasFailedQuestTwo(obj_id player, obj_id npc) throws InterruptedException
    {
        ...
        return (space_quest.hasAbortedQuest(player, "destroy_surpriseattack", "corellia_mining_quest_2") || space_quest.hasFailedQuest(player, "destroy_surpriseattack", "corellia_mining_quest_2")) && !space_quest.hasWonQuest(player, "destroy_surpriseattack", "corellia_mining_quest_2");
    }
