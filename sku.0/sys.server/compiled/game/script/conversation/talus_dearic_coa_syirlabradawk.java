...
public class talus_dearic_coa_syirlabradawk extends script.base_script
{
    ...
    public boolean talus_dearic_coa_syirlabradawk_condition_completed_medic_quest(obj_id player, obj_id npc) throws InterruptedException
    {
        ...
        {
            return groundquests.hasCompletedQuest(player, "talus_dearic_coa_medic_prisoner") && (groundquests.hasCompletedQuest(player, "talus_dearic_coa_opt_rebel_quest") || groundquests.hasCompletedQuest(player, "talus_dearic_coa_rebel_view_end"));
        }
        else
        {
    ...
    {
        return factions.isRebel(player) && groundquests.isTaskActive(player, "talus_dearic_coa_opt_rebel_quest", "talus_dearic_coa_imperials_eliminated_wfs");
    }
    ...
    {
        return factions.isRebel(player) && !groundquests.isQuestActiveOrComplete(player, "talus_dearic_coa_opt_rebel_quest") && groundquests.hasCompletedQuest(player, "talus_dearic_coa_medic_prisoner");
    }
