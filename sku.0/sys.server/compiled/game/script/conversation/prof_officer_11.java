...
public class prof_officer_11 extends script.base_script
{
    ...
    {
        return groundquests.hasCompletedTask(player, "quest/prof_officer_11", "speakToEllis");
    }

    public boolean prof_officer_11_condition_finishingOfficer(obj_id player, obj_id npc) throws InterruptedException
    {
        return groundquests.isTaskActive(player, "quest/prof_officer_11", "finishingEllisOfficerQuest");
    }

    public boolean prof_officer_11_condition_doneWithOfficerQuest(obj_id player, obj_id npc) throws InterruptedException
    {
        return groundquests.hasCompletedQuest(player, "quest/prof_officer_11");
    }
    ...
    {
        return !groundquests.isQuestActive(player, "quest/prof_officer_11");
    }
