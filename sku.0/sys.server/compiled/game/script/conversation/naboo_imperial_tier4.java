...
public class naboo_imperial_tier4 extends script.base_script
{
    ...
    {
        return space_quest.hasAbortedQuestRecursive(player, "patrol", "naboo_imperial_tier4_1") || space_quest.hasFailedQuestRecursive(player, "patrol", "naboo_imperial_tier4_1");
    }

    public boolean naboo_imperial_tier4_condition_failedMissionTwo(obj_id player, obj_id npc) throws InterruptedException
    {
        return space_quest.hasAbortedQuestRecursive(player, "recovery", "naboo_imperial_tier4_2") || space_quest.hasFailedQuestRecursive(player, "recovery", "naboo_imperial_tier4_2");
    }

    public boolean naboo_imperial_tier4_condition_failedMissionThree(obj_id player, obj_id npc) throws InterruptedException
    {
        return space_quest.hasAbortedQuestRecursive(player, "survival", "naboo_imperial_tier4_3") || space_quest.hasFailedQuestRecursive(player, "survival", "naboo_imperial_tier4_3");
    }

    public boolean naboo_imperial_tier4_condition_failedMissionFour(obj_id player, obj_id npc) throws InterruptedException
    {
        return space_quest.hasAbortedQuestRecursive(player, "escort", "naboo_imperial_tier4_4") || space_quest.hasFailedQuestRecursive(player, "escort", "naboo_imperial_tier4_4");
    }

    public boolean naboo_imperial_tier4_condition_failedMasterMission(obj_id player, obj_id npc) throws InterruptedException
    {
        return space_quest.hasAbortedQuestRecursive(player, "destroy", "naboo_imperial_master") || space_quest.hasFailedQuestRecursive(player, "destroy", "naboo_imperial_master");
    }
    ...
    public boolean naboo_imperial_tier4_condition_isGettingMissionOneReward(obj_id player, obj_id npc) throws InterruptedException
    {
        ...
        return !space_quest.hasReceivedReward(player, "patrol", "naboo_imperial_tier4_1");
    }
    ...
    public boolean naboo_imperial_tier4_condition_isGettingMissionTwoReward(obj_id player, obj_id npc) throws InterruptedException
    {
        ...
        return !space_quest.hasReceivedReward(player, "recovery", "naboo_imperial_tier4_2");
    }
    ...
    public boolean naboo_imperial_tier4_condition_isGettingMissionThreeReward(obj_id player, obj_id npc) throws InterruptedException
    {
        ...
        return !space_quest.hasReceivedReward(player, "survival", "naboo_imperial_tier4_3");
    }
    ...
    public boolean naboo_imperial_tier4_condition_isGettingMissionFourReward(obj_id player, obj_id npc) throws InterruptedException
    {
        ...
        return !space_quest.hasReceivedReward(player, "escort", "naboo_imperial_tier4_4");
    }
    ...
    public boolean naboo_imperial_tier4_condition_isGettingMasterMissionReward(obj_id player, obj_id npc) throws InterruptedException
    {
        ...
        return !space_quest.hasReceivedReward(player, "destroy", "naboo_imperial_master");
    }
    ...
    {
        return space_quest.hasCompletedQuestRecursive(player, "survival", "naboo_imperial_tier4_3");
    }
    ...
    {
        return space_quest.hasCompletedQuestRecursive(player, "recovery", "naboo_imperial_tier4_2");
    }
    ...
    {
        return space_quest.hasCompletedQuestRecursive(player, "patrol", "naboo_imperial_tier4_1");
    }
