...
public class ep3_forest_cryl extends script.base_script
{
    ...
    {
        return groundquests.isTaskActive(player, "ep3_forest_cryl_quest_1", 0) || groundquests.hasCompletedTask(player, "ep3_forest_cryl_quest_1", 0);
    }
    ...
    {
        return groundquests.isTaskActive(player, "ep3_forest_cryl_quest_2", 0) || groundquests.hasCompletedTask(player, "ep3_forest_cryl_quest_2", 0);
    }
