...
public class tatooine_eisley_purvis extends script.base_script
{
    ...
    {
        return groundquests.hasCompletedQuest(player, "quest/purvis_kill_warriors");
    }

    public boolean tatooine_eisley_purvis_condition_isReadyForPurvis(obj_id player, obj_id npc) throws InterruptedException
    {
        return groundquests.hasCompletedQuest(player, "quest/c_ranged_combat_trainer") || (groundquests.isQuestActive(player, "quest/c_ranged_combat_trainer"));
    }

    public boolean tatooine_eisley_purvis_condition_isOnCombatQuests(obj_id player, obj_id npc) throws InterruptedException
    {
        return groundquests.isQuestActive(player, "quest/purvis_kill_zealots") || groundquests.isQuestActive(player, "quest/purvis_kill_soldiers") || groundquests.isQuestActive(player, "quest/purvis_kill_warriors");
    }

    public boolean tatooine_eisley_purvis_condition_goSeeMayor(obj_id player, obj_id npc) throws InterruptedException
    {
        return groundquests.isTaskActive(player, "quest/purvis_kill_warriors", "newbie_ranged_e7");
    }
    ...
    {
        return groundquests.hasCompletedQuest(player, "quest/purvis_recon_one") || groundquests.isQuestActive(player, "quest/purvis_recon_one");
    }
