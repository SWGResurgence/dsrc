...
{
        if (groundquests.isQuestActive(player, "quest/wod_distorted_visions"))
        {
            return true;
        }
        return false;
...
{
        faceTo(npc, player);
        if (groundquests.isTaskActive(player, "quest/wod_distorted_visions", "returnMerillaOne"))
        {
            return true;
        }
        return false;
...
{
        if (groundquests.hasCompletedQuest(player, "quest/wod_distorted_visions"))
        {
            return true;
        }
        return false;
...
{
        if (groundquests.hasCompletedQuest(player, "quest/wod_silencing_the_spellweavers_one"))
        {
            return true;
        }
        return false;
...
{
        faceTo(npc, player);
        if (groundquests.isTaskActive(player, "quest/wod_silencing_the_spellweavers_one", "returnMerillaTwo"))
        {
            return true;
        }
        return false;
...
{
        if (groundquests.isQuestActive(player, "quest/wod_seeking_the_spellweavers_one") || groundquests.isQuestActive(player, "quest/wod_silencing_the_spellweavers_one"))
        {
            return true;
        }
        return false;
...
{
        if (groundquests.hasCompletedQuest(player, "quest/wod_silencing_the_spellweavers_two"))
        {
            return true;
        }
        return false;
...
{
        if (groundquests.hasCompletedQuest(player, "quest/wod_silencing_the_spellweavers_one") && groundquests.hasCompletedQuest(player, "quest/wod_scouting_for_salvage"))
        {
            return true;
        }
        return false;
...
{
        if (groundquests.isQuestActive(player, "quest/wod_silencing_the_spellweavers_two"))
        {
            return true;
        }
        return false;
...
{
        faceTo(npc, player);
        if (groundquests.isTaskActive(player, "quest/wod_silencing_the_spellweavers_two", "returnMerillaThree"))
        {
            return true;
        }
        return false;
