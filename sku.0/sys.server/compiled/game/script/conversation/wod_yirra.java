...
// ----------------------------------------------------------------------
    ...
    public boolean wod_yirra_condition_isOnPreQuestSM(obj_id player, obj_id npc) throws InterruptedException
    {
        ...
        {
            return badge.hasBadge(player, "bdg_wod_sm_trust") && badge.hasBadge(player, "bdg_wod_sm_spider_quests") && badge.hasBadge(player, "bdg_wod_sm_rancor_quests") && !badge.hasBadge(player, "bdg_wod_ns_trust") && !badge.hasBadge(player, "bdg_wod_ns_spider_quests") && !badge.hasBadge(player, "bdg_wod_ns_rancor_quests");
        }
        return false;
    }
...
// ----------------------------------------------------------------------
    ...
    public boolean wod_yirra_condition_isOnPreQuestNS(obj_id player, obj_id npc) throws InterruptedException
    {
        if (groundquests.isTaskActive(player, "quest/wod_arlin_goto_rh", "talkToYirra"))
        {
            return badge.hasBadge(player, "bdg_wod_ns_trust") && badge.hasBadge(player, "bdg_wod_ns_spider_quests") && badge.hasBadge(player, "bdg_wod_ns_rancor_quests") && !badge.hasBadge(player, "bdg_wod_sm_trust") && !badge.hasBadge(player, "bdg_wod_sm_spider_quests") && !badge.hasBadge(player, "bdg_wod_sm_rancor_quests");
        }
        return false;
    }
...
// ----------------------------------------------------------------------
    ...
    {
        return groundquests.isQuestActive(player, "quest/wod_seeking_retribution");
    }
...
// ----------------------------------------------------------------------
    ...
    {
        faceTo(npc, player);
        return groundquests.isTaskActive(player, "quest/wod_seeking_retribution", "returnYirraOne");
...
// ----------------------------------------------------------------------
    ...
    {
        return groundquests.hasCompletedQuest(player, "quest/wod_arlin_goto_rh");
    }
...
// ----------------------------------------------------------------------
    ...
    {
        return groundquests.isQuestActive(player, "quest/wod_trail_of_discovery");
    }
...
// ----------------------------------------------------------------------
    ...
    {
        faceTo(npc, player);
        return groundquests.isTaskActive(player, "quest/wod_trail_of_discovery", "returnYirraTwo");
