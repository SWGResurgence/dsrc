...
// ----------------------------------------------------------------------
    ...
    {
        return groundquests.hasCompletedQuest(player, "quest/wod_seeking_retribution");
    }
...
// ----------------------------------------------------------------------
    ...
    {
        return groundquests.isQuestActive(player, "quest/wod_interfering_forces");
    }
...
// ----------------------------------------------------------------------
    ...
    {
        faceTo(npc, player);
        return groundquests.isTaskActive(player, "quest/wod_interfering_forces", "returnKyreneOne");
...
// ----------------------------------------------------------------------
    ...
    {
        return groundquests.hasCompletedQuest(player, "quest/wod_interfering_forces");
    }
...
// ----------------------------------------------------------------------
    ...
    {
        return groundquests.isQuestActive(player, "quest/wod_interfering_forces_2");
    }
...
// ----------------------------------------------------------------------
    ...
    {
        return groundquests.hasCompletedQuest(player, "quest/wod_interfering_forces_2");
    }
...
// ----------------------------------------------------------------------
    ...
    {
        faceTo(npc, player);
        return groundquests.isTaskActive(player, "quest/wod_interfering_forces_2", "returnKyreneTwo");
...
// ----------------------------------------------------------------------
    ...
    {
        return groundquests.isQuestActive(player, "quest/wod_kill_remnant_spider_clan");
    }
...
// ----------------------------------------------------------------------
    ...
    {
        return groundquests.isQuestActive(player, "quest/wod_kill_dathomir_imperials");
    }
...
// ----------------------------------------------------------------------
    ...
    {
        return groundquests.isQuestActive(player, "quest/wod_kill_sith_shadows");
    }
...
// ----------------------------------------------------------------------
    ...
    {
        return groundquests.isQuestActive(player, "quest/wod_kill_afflicted_witches");
    }
...
// ----------------------------------------------------------------------
    ...
    {
        faceTo(npc, player);
        return groundquests.isTaskActive(player, "quest/wod_kill_remnant_spider_clan", "returnKyreneRepeatOne");
...
// ----------------------------------------------------------------------
    ...
    {
        faceTo(npc, player);
        return groundquests.isTaskActive(player, "quest/wod_kill_dathomir_imperials", "returnKyreneRepeatTwo");
...
// ----------------------------------------------------------------------
    ...
    {
        faceTo(npc, player);
        return groundquests.isTaskActive(player, "quest/wod_kill_sith_shadows", "returnKyreneRepeatThree");
...
// ----------------------------------------------------------------------
    ...
    {
        faceTo(npc, player);
        return groundquests.isTaskActive(player, "quest/wod_kill_afflicted_witches", "returnKyreneRepeatFour");
