...
public class ep3_myyydril_chief extends script.base_script
{
    ...
    {
        return groundquests.isTaskActive(player, "ep3_myyydril_kivvaaa_talkto_1", 0) || groundquests.hasCompletedTask(player, "ep3_myyydril_kivvaaa_talkto_1", 0);
    }
    ...
    {
        return groundquests.isTaskActive(player, "ep3_myyydril_nawika_talkto_5", 0) || groundquests.hasCompletedTask(player, "ep3_myyydril_nawika_talkto_5", 0);
    }
    ...
    public boolean ep3_myyydril_chief_condition_needsQuestCorrection(obj_id player, obj_id npc) throws InterruptedException
    {
        ...
        {
            return !groundquests.hasCompletedQuest(player, "ep3_myyydril_kallaarac_talkto_2") && !groundquests.isQuestActive(player, "ep3_myyydril_kallaarac_talkto_2");
        }
        return false;
    }
    ...
    {
        return groundquests.isTaskActive(player, "ep3_myyydril_kallaarac_destroy_2", 0) || groundquests.hasCompletedTask(player, "ep3_myyydril_kallaarac_destroy_2", 0);
    }
    ...
    {
        return groundquests.isTaskActive(player, "ep3_myyydril_kallaarac_retrieve_1", 0) || groundquests.hasCompletedTask(player, "ep3_myyydril_kallaarac_retrieve_1", 0);
    }
    ...
    {
        return groundquests.isTaskActive(player, "ep3_myyydril_kallaarac_destroy_3", 0) || groundquests.hasCompletedTask(player, "ep3_myyydril_kallaarac_destroy_3", 0);
    }
