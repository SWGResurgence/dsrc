...
public class ep3_forest_kerritamba_epic extends script.base_script
{
    ...
    {
        return groundquests.isTaskActive(player, "ep3_forest_ardon_quest_1", 0) || groundquests.hasCompletedTask(player, "ep3_forest_ardon_quest_1", 0);
    }
    ...
    {
        return groundquests.isTaskActive(player, "ep3_forest_ardon_quest_2", 0) || groundquests.hasCompletedTask(player, "ep3_forest_ardon_quest_2", 0);
    }
    ...
    {
        return groundquests.isTaskActive(player, "ep3_forest_ardon_quest_3", 0) || groundquests.hasCompletedTask(player, "ep3_forest_ardon_quest_3", 0);
    }
    ...
    {
        return badge.hasBadge(player, "bdg_kash_kerritamba");
    }
