...
public class heroic_prequest_bypass extends script.conversation.base.conversation_base {
    ...
    public static OnStartNpcConversation(obj_id self, obj_id player) {
    ...
    public static OnNpcConversationResponse(obj_id self, String conversationName, obj_id player, string_id response) throws InterruptedException {
