...
public class tyrena_lyman_zavala extends script.base_script
{
    ...
    {
        return groundquests.isQuestActive(player, "quest/tyrena_lyman_evidence");
    }

    public boolean tyrena_lyman_zavala_condition_waitingForLymanFinish(obj_id player, obj_id npc) throws InterruptedException
    {
        return groundquests.hasCompletedTask(player, "quest/tyrena_lyman_olag_greck", "returningToLyman");
    }

    public boolean tyrena_lyman_zavala_condition_needTakouhliWaypoint(obj_id player, obj_id npc) throws InterruptedException
    {
        return groundquests.hasCompletedQuest(player, "quest/tyrena_lyman_olag_greck") && !groundquests.isQuestActiveOrComplete(player, "quest/tyrena_meet_the_meatlumps");
    }
    ...
    {
        return groundquests.isQuestActive(player, "quest/tyrena_lyman_olag_greck");
    }

    public boolean tyrena_lyman_zavala_condition_finishingOlagQuest(obj_id player, obj_id npc) throws InterruptedException
    {
        return groundquests.isTaskActive(player, "quest/tyrena_lyman_olag_greck", "returningToLyman");
    }
