...
public class ep3_trandoshan_lesnorr extends script.base_script
{
    ...
    {
        return space_quest.hasFailedQuestRecursive(player, "convoy", "ep3_trando_lesnorr") || space_quest.hasAbortedQuestRecursive(player, "convoy", "ep3_trando_lesnorr");
    }

    public boolean ep3_trandoshan_lesnorr_condition_hasRecievedReward(obj_id player, obj_id npc) throws InterruptedException
    {
        return space_quest.hasReceivedReward(player, "convoy", "ep3_trando_lesnorr");
    }
