...
public class ep3_forest_perusta extends script.base_script
{
    ...
    {
        return groundquests.isTaskActive(player, "ep3_forest_perusta_quest_1", 0) || groundquests.hasCompletedTask(player, "ep3_forest_perusta_quest_1", 0);
    }
    ...
    {
        return groundquests.isTaskActive(player, "ep3_forest_perusta_quest_2", 0) || groundquests.hasCompletedTask(player, "ep3_forest_perusta_quest_2", 0);
    }
