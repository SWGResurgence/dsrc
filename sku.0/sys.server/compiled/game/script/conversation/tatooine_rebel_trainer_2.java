...
public class tatooine_rebel_trainer_2 extends script.base_script
{
    ...
    {
        return hasSkill(player, "pilot_rebel_navy_navigation_01") && hasSkill(player, "pilot_rebel_navy_starships_01") && hasSkill(player, "pilot_rebel_navy_combat_01") && hasSkill(player, "pilot_rebel_navy_droid_01");
    }

    public boolean tatooine_rebel_trainer_2_condition_hasWonAllQuests(obj_id player, obj_id npc) throws InterruptedException
    {
        return tatooine_rebel_trainer_2_condition_hasWonFirstQuest(player, npc) && tatooine_rebel_trainer_2_condition_hasWonSecondQuest(player, npc) && tatooine_rebel_trainer_2_condition_hasWonThirdQuest(player, npc) && tatooine_rebel_trainer_2_condition_hasFinishedNewbieSeries(player, npc);
    }

    public boolean tatooine_rebel_trainer_2_condition_readyForPromotion(obj_id player, obj_id npc) throws InterruptedException
    {
        return tatooine_rebel_trainer_2_condition_hasWonAllQuests(player, npc) && (!tatooine_rebel_trainer_2_condition_hasAnyTier1Skills(player, npc)) && tatooine_rebel_trainer_2_condition_hasRebelSkill(player, npc);
    }
    ...
    {
        return space_quest.hasFailedQuest(player, "destroy", "rebel_destroy_03");
    }
    ...
    {
        faceTo(npc, player);
        return space_quest.hasAbortedQuest(player, "destroy", "rebel_destroy_03");
    }

    public boolean tatooine_rebel_trainer_2_condition_hasFirstQuest(obj_id player, obj_id npc) throws InterruptedException
    {
        return space_quest.hasQuest(player, "destroy", "rebel_destroy_03") || space_quest.hasCompletedQuest(player, "destroy", "rebel_destroy_03");
    }
