...
public class som_obi_wan_kenobi extends script.base_script
{
    ...
    {
        return !groundquests.isQuestActive(player, "som_obi_wan_signal_1") && !groundquests.hasCompletedQuest(player, "som_obi_wan_signal_1");
    }

    public boolean som_obi_wan_kenobi_condition_isQuest1Active(obj_id player, obj_id npc) throws InterruptedException
    {
        return groundquests.isQuestActive(player, "som_obi_wan_signal_1");
    }

    public boolean som_obi_wan_kenobi_condition_hasCompletedQuest1(obj_id player, obj_id npc) throws InterruptedException
    {
        return groundquests.hasCompletedQuest(player, "som_obi_wan_signal_1") && groundquests.isQuestActive(player, "som_obi_wan_signal_2");
    }
