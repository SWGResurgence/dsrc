...
public class combat_engine
{
    ...
    public static combat_data getCombatData(String actionName)
    {
        ...
        {
            return combat_data.clone(m_CombatDataCache.get(actionName));
        }
    ...
    public static buff_data getBuffData(int buffNameCrc)
    {
        ...
        {
            return buff_data.clone(m_BuffDataCache.get(Integer.toString(buffNameCrc)));
        }
...
//		System.out.println("***Java combat_engine: base dist = " + attacker.worldPos.distance(defender.worldPos) + ", adjusted dist = " + dist + ", rangeMod = " + rangeMod);
     ...
     *
     * @param defender
     *         the object that was being attacked
    ...
    private static String getWeaponStringType(int intWeaponType)
    {
        ...
        {
            case base_class.WEAPON_TYPE_RIFLE:
                return "rifle";
            case base_class.WEAPON_TYPE_LIGHT_RIFLE:
                return "carbine";
            case base_class.WEAPON_TYPE_PISTOL:
                return "pistol";
            case base_class.WEAPON_TYPE_HEAVY:
                return "heavyWeapon";
            case base_class.WEAPON_TYPE_1HAND_MELEE:
                return "1handMelee";
            case base_class.WEAPON_TYPE_2HAND_MELEE:
                return "2handeMelee";
            case base_class.WEAPON_TYPE_UNARMED:
                return "unarmed";
            case base_class.WEAPON_TYPE_POLEARM:
                return "polearm";
            case base_class.WEAPON_TYPE_THROWN:
                return "thrown";
        }
        return "";
    }
    ...
    private static boolean isLocomotionMoving(int intLocomotion)
    {
        ...
        {
            case base_class.LOCOMOTION_SNEAKING:
                return true;
            case base_class.LOCOMOTION_WALKING:
                return true;
            case base_class.LOCOMOTION_RUNNING:
                return true;
            case base_class.LOCOMOTION_CRAWLING:
                return true;
            case base_class.LOCOMOTION_CLIMBING:
                return true;
            case base_class.LOCOMOTION_FLYING:
                return true;
            case base_class.LOCOMOTION_DRIVING_VEHICLE:
                return true;
            case base_class.LOCOMOTION_RIDING_CREATURE:
                return true;
        }
        return false;
    }
    ...
    private static int getPostureModForWeapon(obj_id objPlayer, int intPosture, int intWeaponType)
    {
        switch (intPosture)
        {
            case base_class.POSTURE_CROUCHED:
                return base_class.getSkillStatisticModifier(objPlayer, getWeaponStringType(intWeaponType) + "_kneeling");
            case base_class.POSTURE_PRONE:
                return base_class.getSkillStatisticModifier(objPlayer, getWeaponStringType(intWeaponType) + "_prone");
            case base_class.POSTURE_UPRIGHT:
                return base_class.getSkillStatisticModifier(objPlayer, getWeaponStringType(intWeaponType) + "_standing");
