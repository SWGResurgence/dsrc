...
public class random
{
    ...
    private static final java.util.Random sysRand = new java.util.Random();
     ...
     *
     * @param min
     *         lower value of random integer
     * @param max
     *         upper value of random integer
     * @param dist
     *         distribution mean of random number
     ...
     *
     * @param min
     *         lower value of random float
     * @param max
     *         upper value of random float
     * @param dist
     *         distribution mean of random number
     * @return a random float
     */
     ...
     * @param base
     *         number to add to the result of rolling the dice
