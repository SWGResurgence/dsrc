...
public final class obj_id implements Comparable, Serializable
{
    ...
    private static final HashSet potentiallyDirtyObjects = new HashSet();        // list of ids whose scriptvars may have changed
    private static final Hashtable m_factory = new Hashtable(100003);            // keeps track of all ids currently in the game
    private static final obj_id_cleanup m_cleanup;                            // removes obj_ids from the factory after all references to the id have been cleared
    ...
    private final transient Long m_id;                    // the actual id
    ...
    private final transient ArrayList m_scripts;            // list of scripts attached to this object
    private transient int m_scriptLock;                // semaphore-type counter to prevent modification of the script list
    private final transient ArrayList m_pendingScripts;
     ...
     *
     * @param scriptName
     *         the name of the script to look for
     ...
     *
     * @param authoritative
     *         flag that the object is authoritative
     */
    ...
    private final class pending_script
    {
        ...
        public pending_script(boolean add, String script)
        {
            this.add = add;
            this.script = script;
        }
