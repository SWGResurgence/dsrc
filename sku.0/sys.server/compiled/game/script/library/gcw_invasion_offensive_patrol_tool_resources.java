...
public class gcw_invasion_offensive_patrol_tool_resources extends script.base_script {
	...
	public static obj_id[] grantInvasionResources(obj_id player) throws InterruptedException {
		...
		theSet.add(static_item.createNewItemFunction("item_gcw_landing_beacon", pInv, 50));
    theSet.add(static_item.createNewItemFunction("item_gcw_signal_amplifier", pInv, 50));
