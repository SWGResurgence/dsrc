...
public class gcw_invasion_tool_contraband_resources extends script.base_script {
	...
	public static obj_id[] grantInvasionResources(obj_id player) throws InterruptedException {
		...
		theSet.add(static_item.createNewItemFunction("item_gcw_material_enhancers", pInv, 25));
    theSet.add(static_item.createNewItemFunction("item_gcw_manufacturing_boosters", pInv, 25));
