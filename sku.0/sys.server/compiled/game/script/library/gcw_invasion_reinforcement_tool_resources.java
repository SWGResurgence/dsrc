...
public class gcw_invasion_reinforcement_tool_resources extends script.base_script {
	...
	public static obj_id[] grantInvasionResources(obj_id player) throws InterruptedException {
		...
		theSet.add(static_item.createNewItemFunction("item_gcw_adrenalin_stimulant", pInv, 50));
    theSet.add(static_item.createNewItemFunction("item_gcw_bacta_injectors", pInv, 50));
