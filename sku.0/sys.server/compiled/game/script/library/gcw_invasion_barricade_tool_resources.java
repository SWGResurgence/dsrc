...
public class gcw_invasion_barricade_tool_resources extends script.base_script {
	...
	public static obj_id[] grantInvasionResources(obj_id player) throws InterruptedException {
		...
		theSet.add(static_item.createNewItemFunction("item_gcw_energy_absorbant", pInv, 50));
    theSet.add(static_item.createNewItemFunction("item_gcw_high_density_plating", pInv, 50));
