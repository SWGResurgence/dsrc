...
public class vet_reward_token_box_medium_02 extends script.base_script {
    ...
    public static obj_id[] grantVetTokens(obj_id player) throws InterruptedException {
        ...
        theSet.add(static_item.createNewItemFunction("item_vet_reward_token_01_01", pInv, 100));
