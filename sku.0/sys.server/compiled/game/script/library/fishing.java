...
public class fishing extends script.base_script
{
     ...
     *
     * @param fish
     *         the fish to get the species of
     ...
     *
     * @param fish
     *         the fish to get the origin planet of
     ...
     *
     * @param fish
     *         the name of the elusive fish (reference elusive fish datatable) e.g. bluefish_dantooine
     */
     ...
     *
     * @param player
     *         the player who should get the SUI window
     */
    public static void showElusiveFishLeaderboard(obj_id player) throws InterruptedException
    {
        ...
        for (int i = 0; i < fishCount; i++)
        {
            ...
            System.arraycopy(leaderboardEntry, 0, leaderboardData[i], 0, leaderboardEntry.length);
        }
