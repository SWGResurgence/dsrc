...
public class gcw_tower_barricade_tool_resources extends script.base_script {
	...
	public static obj_id[] grantInvasionResources(obj_id player) throws InterruptedException {
		...
		theSet.add(static_item.createNewItemFunction("item_gcw_heat_resistant_wiring", pInv, 50));
    theSet.add(static_item.createNewItemFunction("item_gcw_high_performance_circuit_board", pInv, 50));
