...
public class profession_bounty_hunter extends script.base_script {
	...
	public int OnObjectMenuSelect(obj_id self, obj_id player, int item) throws InterruptedException {
		if (item == menu_info_types.ITEM_USE) {
            ...
            obj_id[] allTheArmor = grantBountyHunterUniform(player);
            destroyObject(self);
            return SCRIPT_CONTINUE;
		}
		return SCRIPT_CONTINUE;
	}
	public static obj_id[] grantBountyHunterUniform(obj_id player) throws InterruptedException {
