...
public class gcw_invasion_offensive_vehicle_tool_resources extends script.base_script {
	...
	public static obj_id[] grantInvasionResources(obj_id player) throws InterruptedException {
		...
		theSet.add(static_item.createNewItemFunction("item_gcw_engine_booster", pInv, 50));
    theSet.add(static_item.createNewItemFunction("item_gcw_weapon_stabilizers", pInv, 50));
