...
public class profession_entertainer_male extends script.base_script {
	...
	public int OnObjectMenuSelect(obj_id self, obj_id player, int item) throws InterruptedException {
		if (item == menu_info_types.ITEM_USE) {
            ...
            obj_id[] allTheArmor = grantEntertainerMaleUniform(player);
            destroyObject(self);
            return SCRIPT_CONTINUE;
		}
		return SCRIPT_CONTINUE;
	}
	public static obj_id[] grantEntertainerMaleUniform(obj_id player) throws InterruptedException {
    ...
    theSet.add(static_item.createNewItemFunction("item_entertainer_hat_02_01"));
