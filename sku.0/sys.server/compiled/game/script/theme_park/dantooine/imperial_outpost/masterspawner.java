...
public class masterspawner extends script.base_script
{
    ...
    private final float[][] droidPatrolCoords = {
    ...
    private final float[][] officerPatrolPoints = {
    ...
    private final float[][] smallSquadOnePoints = {
    ...
    private final float[][] smallSquadTwoPoints = {
    ...
    private final float[][] smallSquadThreePoints = {
            {-4287.9f, 3.0f, -2407.9f},
            {-4277.5f, 3.0f, -2407.9f},
            {-4272.7f, 3.0f, -2395.9f},
            {-4232.2f, 3.0f, -2395.9f},
    ...
    private final float[][] smallSquadFourPoints = {
            {-4160.9f, 3.0f, -2407.9f},
            {-4173.8f, 3.0f, -2407.9f},
            {-4176.7f, 3.0f, -2396.0f},
            {-4216.5f, 3.0f, -2396.0f},
    ...
    private final float[][] largeSquadOnePoints = {
    ...
    private final float[][] largeSquadTwoPoints = {
            {-4176.7f, 3.0f, -2395.1f},
            {-4176.7f, 3.0f, -2419.1f},
            {-4272.7f, 3.0f, -2419.1f},
            {-4272.7f, 3.0f, -2407.1f},
    ...
    private final String[][] droidTypes = {
    ...
    private void spawnCommoners() throws InterruptedException
    {
        ...
        // in the datatable.  Lame, I know.
        float[][] coords = {
                {-4260.1f, 3.0f, -2425.0f, rand(1.0f, 180.0f)},
