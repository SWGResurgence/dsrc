    ...
    public int OnCreatureDamaged(obj_id self, obj_id attacker, obj_id wpn, int[] damage) throws InterruptedException
    {
        ...
        if (percentHealth <= 75)
        {
            if (!utils.hasScriptVar(self, "hasSpawned"))
            {
                ...
                resurgence.createCircleSpawn(self, self,"emperors_hand_stormtroopers", 8, 6);
        ...
        if (percentHealth <= 20)
        {
            if (!utils.hasScriptVar(self, "hasDisarmed"))
            {
                ...
                resurgence.createCircleSpawn(self, self, "emperors_hand_isb_guards", 4, 6);
        ...
        if (percentHealth <= 10)
        {
            if (!utils.hasScriptVar(self, "feelsDarkSideForce"))
            {
                ...
                for (obj_id who : players)
                {
                    ...
                    resurgence.createCircleSpawn(self, self, "emperors_hand_inquisitors", 2, 3);
                }
            }
            if (percentHealth <= 1)
            {
