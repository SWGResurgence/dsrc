...
public class crafting_structure_atat extends script.base_script
{
    ...
    public int OnInitialize(obj_id self)
    {
        ...
        if (buildingTemplate.indexOf(PLAYER_HOUSE_ATAT) > 0)
        {
            spawnInvCraftingStation(self, craftinglib.STATION_TYPE_ATAT);
        }
        return SCRIPT_CONTINUE;
    }
