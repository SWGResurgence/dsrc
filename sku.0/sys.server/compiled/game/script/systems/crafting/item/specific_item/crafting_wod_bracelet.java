...
@Filename: script.systems.crafting.item.specific_item.
@Author: BubbaJoeX
@Purpose:
*/
...
public class crafting_wod_bracelet extends script.systems.crafting.item.crafting_base_item_component
{
