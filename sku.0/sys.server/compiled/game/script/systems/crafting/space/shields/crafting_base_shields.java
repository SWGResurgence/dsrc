    ...
    public void calcAndSetPrototypeProperties(obj_id prototype, draft_schematic.attribute[] itemAttributes) throws InterruptedException
    {
        ...
        for (draft_schematic.attribute itemAttribute : itemAttributes)
        {
            ...
            if (!calcAndSetPrototypeProperty(prototype, itemAttribute))
            {
                ...
                {
                    space_crafting.setShieldGeneratorMaximumFrontHitpoints(prototype, itemAttribute.currentValue);
                    space_crafting.setShieldGeneratorCurrentFrontHitpoints(prototype, itemAttribute.currentValue);
                }
                if (((itemAttribute.name).getAsciiId()).equals("shield_max_back_hp"))
                {
                    space_crafting.setShieldGeneratorMaximumBackHitpoints(prototype, itemAttribute.currentValue);
                    space_crafting.setShieldGeneratorCurrentBackHitpoints(prototype, itemAttribute.currentValue);
                }
                if (((itemAttribute.name).getAsciiId()).equals("shield_recharge"))
                {
                    space_crafting.setShieldGeneratorRechargeRate(prototype, itemAttribute.currentValue);
                }
                else
                {
