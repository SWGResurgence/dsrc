...
public class crafting_structure_meditation extends script.base_script
{
    ...
    public static final String PLAYER_HOUSE_JEDI_MEDITATION_ROOM = "player_house_jedi_meditation_room";
    public static final String PLAYER_HOUSE_SITH_MEDITATION_ROOM = "player_house_sith_meditation_room";
    public int OnInitialize(obj_id self)
    {
        ...
        if (buildingTemplate.indexOf(PLAYER_HOUSE_JEDI_MEDITATION_ROOM) > 0)
        {
            spawnInvCraftingStation(self, craftinglib.STATION_TYPE_JEDI_MEDITATION_ROOM);
        }
        if (buildingTemplate.indexOf(PLAYER_HOUSE_SITH_MEDITATION_ROOM) > 0)
        {
            spawnInvCraftingStation(self, craftinglib.STATION_TYPE_SITH_MEDITATION_ROOM);
        }
        return SCRIPT_CONTINUE;
    }
