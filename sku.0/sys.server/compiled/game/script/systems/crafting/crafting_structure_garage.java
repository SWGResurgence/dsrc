...
public class crafting_structure_garage extends base_script
{
    ...
    public static final String PLAYER_HOUSE_GARAGE = "player_house_garage";
    public int OnInitialize(obj_id self) {
        String buildingTemplate = getTemplateName(self);
        if (buildingTemplate == null || buildingTemplate.equals("")) {
            return SCRIPT_CONTINUE;
        }
        if (buildingTemplate.indexOf(PLAYER_HOUSE_GARAGE) > 0) {
            spawnInvCraftingStation(self, craftinglib.STATION_TYPE_GARAGE);
        }
        return SCRIPT_CONTINUE;
    }
