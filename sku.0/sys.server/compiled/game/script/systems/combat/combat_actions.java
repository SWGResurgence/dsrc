...
public class combat_actions extends script.systems.combat.combat_base
{
    ...
    public boolean hasEgg(obj_id player) throws InterruptedException
    {
        ...
        return isValidId(egg) && utils.hasScriptVar(egg, "objOwner");
    }
    ...
    public int of_rally_point_off(obj_id self, obj_id target, String params, float defaultTime) throws InterruptedException
    {
        ...
        duration += getEnhancedSkillStatisticModifierUncapped(self, "rally_point_duration");
    ...
    public int sm_spot_a_sucker_1(obj_id self, obj_id target, String params, float defaultTime) throws InterruptedException
    {
        ...
        {
            int glanceMod = getEnhancedSkillStatisticModifierUncapped(self, "expertise_spot_a_sucker_glance_chance");
            int criticalMod = getEnhancedSkillStatisticModifierUncapped(self, "expertise_spot_a_sucker_critical_decrease");
            int damageDecrease = getEnhancedSkillStatisticModifierUncapped(self, "expertise_spot_a_sucker_damage_decrease_chance");
    ...
    public int sm_off_the_cuff(obj_id self, obj_id target, String params, float defaultTime) throws InterruptedException
    {
        ...
        int doubleDeal = getSkillStatisticModifier(self, "expertise_double_deal_chance");
    ...
    {
        int crippleChanceMod = getEnhancedSkillStatisticModifierUncapped(self, "expertise_sp_cripple_trap_proc_increase");
        int roll = rand(1, 100);
    ...
    public int blueGlowie(obj_id self, obj_id target, String params, float defaultTime) throws InterruptedException
    {
        ...
        setState(self, STATE_GLOWING_JEDI, getState(self, STATE_GLOWING_JEDI) == 0);
        return SCRIPT_CONTINUE;
    }
    ...
    {
        int voidEffectMod = getEnhancedSkillStatisticModifierUncapped(self, "eexpertise_buff_en_void_dance_buff");
    ...
    {
        int thrillEffectMod = getEnhancedSkillStatisticModifierUncapped(self, "expertise_en_debuff_thrill_increase");
    ...
    {
        return utils.hasScriptVar(self, "outbreak.innoculated") || buff.hasBuff(self, "death_troopers_inoculation");
    }
