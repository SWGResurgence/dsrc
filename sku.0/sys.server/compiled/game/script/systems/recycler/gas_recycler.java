...
public class gas_recycler extends script.base_script {
    ...
    public int OnObjectMenuRequest(obj_id self, obj_id player, menu_info mi) throws InterruptedException {
        ...
        string_id gasReactive = new string_id(STF, "gas_reactive");
        string_id gasInert = new string_id(STF, "gas_inert");
        int mnuOptions = -1;
        ...
        if (mnuOptions > 0) {
            int subClass = mi.addSubMenu(mnuOptions, menu_info_types.SERVER_MENU1, gasReactive);
            int subClass2 = mi.addSubMenu(mnuOptions, menu_info_types.SERVER_MENU2, gasInert);
        }
        return SCRIPT_CONTINUE;
    }
