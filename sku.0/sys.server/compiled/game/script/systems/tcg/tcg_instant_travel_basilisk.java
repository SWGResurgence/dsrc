...
public class tcg_instant_travel extends script.base_script
{
    ...
    public void retrieveLocationsList(obj_id itv, obj_id player) throws InterruptedException
    {
        ...
        if (hasObjVar(itv, "travel_tcg.stationary_itv.name.3") && hasObjVar(itv, "travel_tcg.stationary_itv.location.3") && hasObjVar(itv, "travel_tcg.stationary_itv.scene.3"))
        {
            String name = getStringObjVar(itv, "travel_tcg.stationary_itv.name.3");
            String planet = getStringObjVar(itv, "travel_tcg.stationary_itv.scene.3");
            location loc = getLocationObjVar(itv, "travel_tcg.stationary_itv.location.3");
            String locString = getDisplayLocation(loc);
        ...
        if (hasObjVar(itv, "travel_tcg.stationary_itv.name.4") && hasObjVar(itv, "travel_tcg.stationary_itv.location.4") && hasObjVar(itv, "travel_tcg.stationary_itv.scene.4"))
        {
            String name = getStringObjVar(itv, "travel_tcg.stationary_itv.name.4");
            String planet = getStringObjVar(itv, "travel_tcg.stationary_itv.scene.4");
            location loc = getLocationObjVar(itv, "travel_tcg.stationary_itv.location.4");
            String locString = getDisplayLocation(loc);
        ...
        if (hasObjVar(itv, "travel_tcg.stationary_itv.name.5") && hasObjVar(itv, "travel_tcg.stationary_itv.location.5") && hasObjVar(itv, "travel_tcg.stationary_itv.scene.5"))
        {
            String name = getStringObjVar(itv, "travel_tcg.stationary_itv.name.5");
            String planet = getStringObjVar(itv, "travel_tcg.stationary_itv.scene.5");
            location loc = getLocationObjVar(itv, "travel_tcg.stationary_itv.location.5");
            String locString = getDisplayLocation(loc);
