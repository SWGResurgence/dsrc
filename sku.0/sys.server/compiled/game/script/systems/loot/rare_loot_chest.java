...
public class rare_loot_chest extends script.base_script
{
    ...
    private void handleRareLootCollection(obj_id player, int lootType) throws InterruptedException
    {
        ...
        if (getCollectionSlotValue(player, typeOpenedFive) == 5)
        {
            ...
            {
                case 1:
                    collection.removeCompletedCollection(player, "col_rare_loot_five");
                    break;
                case 2:
                    collection.removeCompletedCollection(player, "col_exceptional_loot_five");
                    break;
                case 3:
                    collection.removeCompletedCollection(player, "col_legendary_loot_five");
                    break;
            }
        }
    }
