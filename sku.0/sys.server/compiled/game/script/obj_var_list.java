...
public final class obj_var_list extends obj_var implements Serializable
{
     ...
     *
     * @param name
     *         name of the obj_var_list to get
    ...
    public boolean isIntObjVar(String name)
    {
        ...
        if (ov != null)
        {
            return ov.getData() != null && ov.getData() instanceof Integer;
        }
        return false;
    }
    ...
    public boolean isIntArrayObjVar(String name)
    {
        ...
        if (ov != null)
        {
            return ov.getData() != null && ov.getData() instanceof int[];
        }
        return false;
    }
    ...
    public boolean isFloatObjVar(String name)
    {
        ...
        if (ov != null)
        {
            return ov.getData() != null && ov.getData() instanceof Float;
        }
        return false;
    }
    ...
    public boolean isStringObjVar(String name)
    {
        ...
        if (ov != null)
        {
            return ov.getData() != null && ov.getData() instanceof String;
        }
        return false;
    }
    ...
    public boolean isObjIdObjVar(String name)
    {
        ...
        if (ov != null)
        {
            return ov.getData() != null && ov.getData() instanceof obj_id;
        }
        return false;
    }
    ...
    public boolean isLocationObjVar(String name)
    {
        ...
        if (ov != null)
        {
            return ov.getData() != null && ov.getData() instanceof location;
        }
        return false;
    }
    ...
    public boolean isStringIdObjVar(String name)
    {
        ...
        if (ov != null)
        {
            return ov.getData() != null && ov.getData() instanceof string_id;
        }
        return false;
    }
    ...
    public boolean isTransformObjVar(String name)
    {
        ...
        if (ov != null)
        {
            return ov.getData() != null && ov.getData() instanceof transform;
        }
        return false;
    }
    ...
    public boolean isVectorObjVar(String name)
    {
        ...
        if (ov != null)
        {
            return ov.getData() != null && ov.getData() instanceof vector;
        }
        return false;
    }
     ...
     *
     * @param data
     *         the obj_var to add to the list
     ...
     *
     * @param name
     *         the name of the obj_var to remove
     ...
     *
     * @param index
     *         the index of the obj_var to remove
