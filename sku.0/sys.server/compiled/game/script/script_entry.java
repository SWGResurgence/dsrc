...
public class script_entry
{
    ...
    private static final Hashtable scriptListeners = new Hashtable();    // scripts that are listening for other script functions to be called
    ...
    private static final Stack ownerContext = new Stack();                // obj_id of the object currently running a script
    ...
    private static final Stack runningScripts = new Stack();              // scripts being run
    private static final Stack runningMethods = new Stack();              // methods being run
...
//		scriptNameBuffer.append("script.");
     ...
     *
     * @param enable
     *         flag to turn tracking on or off
     */
...
*/
     ...
     *         name of the script
     * @param method
     *         name of the script method to call
     * @param params
     *         paramaters to pass to the method
...
//			com.ibm.jvm.Dump.JavaDump();
     ...
     *         name of the script method to call
     * @param object
     *         the object to run the scripts on
     * @param params
     *         the dictionary containing the handler's params
     * @return SCRIPT_CONTINUE or SCRIPT_OVERRIDE
     */
    ...
    public static int callMessageHandlers(String method, obj_id object, dictionary params) throws internal_script_error
    {
        ...
        if (object.getValue() == 0 || !object.isAuthoritative() || !object.isLoaded())
        {
            ...
            {
                System.err.println("WARNING: Java script_entry.callMessageHandlers ERROR: invalid self: " + object + " not authoritative");
                // We've seen errors where Java thinks an object is non-authoritative but C thinks the object
                // is authoritative. _internalIsAuthoritative() will double-check for us and set the obj_id
                // flag if needed
                doubleCheck = base_class._internalIsAuthoritative(object);
                ...
                System.err.println("WARNING: Java script_entry.callMessageHandlers ERROR: invalid self: " + object + " not loaded");
            if (!doubleCheck)
                return base_class.SCRIPT_OVERRIDE;
        }
        object.lockScripts();                        // prevent the object's script list from being modified
     ...
     *
     * @param listenee
     *         object who function we want to listen for
     * @param listeneeFunction
     *         function name on listee we are listening for
     * @param listener
     *         object listening for a function to be called
     * @param listenerScript
     *         script on listener to call when the listenee function is called
     * @param listenerFunction
     *         function name on listener to call when the listenee function is called
     **/
                                            ...
                                            obj_id listener, String listenerScript, String listenerFunction)
    {
        ...
        if (!listenee.isAuthoritative())
        {
            ...
            System.err.println("WARNING: \tlistenee = " + listenee + ", function = " + listeneeFunction);
     ...
     *
     * @param listenee
     *         object that was being listened to
     * @param listeneeFunction
     *         function name that was being listened for
     * @param listener
     *         object that wants to stop listening
     **/
     ...
     *
     * @param listenee
     *         the script whose original function was called
     * @param function
     *         function that was called on the listenee
     * @param params
     *         parameters that were sent to the listenee's function
     **/
    public void callScriptListeners(obj_id listenee, String function, Object[] params) throws internal_script_error, internal_script_exception
    {
        ...
        if (functions != null)
        {
            ...
            if (listeners != null && listeners.size() > 0)
            {
                ...
                System.arraycopy(params, 0, listenerParams, 1, params.length);
    ...
    {
        private final obj_id m_listener;        // who is listening
        private final String m_script;        // listener script to call
        private final String m_function;        // listener function to call
        ...
        public boolean equals(Object obj)
        {
            ...
            try
            {
                ...
                return data.m_listener == m_listener;
            } catch (ClassCastException err)
            {
            }
