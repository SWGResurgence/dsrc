...
public class mental_state_mod implements Comparable, Serializable
{
    ...
    private final int m_mental_state;        // which mental state the modifier affects
    private final float m_value;        // the modifier value
    private final float m_duration;    // how long it lasts
    private final float m_attack;        // time it takes to go from 0 to m_value
    private final float m_decay;        // time it takes to go from m_value to 0

    /**
     * Class constructor.
     *
     * @param state
     *         modifier mental state
     * @param value
     *         modifier value
     * @param duration
     *         how long it lasts
     * @param attack
     *         time it takes to go from 0 to m_value
     * @param decay
     *         time it takes to go from m_value to 0 (MOD_WOUND = wound, MOD_FAUCET = use mentalState faucet)
     */
