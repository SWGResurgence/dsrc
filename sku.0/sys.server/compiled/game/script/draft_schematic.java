...
public class draft_schematic
{
    ...
    private final slot[] m_slots = null;                        // schematic slots used to make the object
    private final attribute[] m_attribs = null;                // attributes the schematic can affect
    private final attribute[] m_experimentalAttribs = null;    // attributes seen by the player during experimentation
    private final custom[] m_customizations = null;            // customization data for objects created by this schematic
    private final Hashtable m_attribMap = null;            // map of object attributes to experimental attributes (assembly), or
    // map of experimental attributes to an array of object attributes (experimentation)
    private final int m_objectTemplateCreated = 0;            // object template crc for the object the schematic creates
    private final String[] m_scripts = null;                  // scripts that gets attached to the manf schematic/factory crate
    /**
