...
public final class transform implements Comparable, Serializable
{
     ...
     *
     * @param tr
     *         the transform to compare this against
     ...
     *
     * @param tr
     *         the transform to multiply this transform by
     ...
     *
     * @param vec
     *         vector to rotate and translate
     ...
     *
     * @param vec
     *         Displacement to move in parent space
     * @return the resulting translated transform
     */
     ...
     *
     * @param x
     *         the x component of the new position vector
     * @param y
     *         the y component of the new position vector
     * @param z
     *         the z component of the new position vector
     * @return the transform with its translation component set to the new position
     */
     ...
     *
     * @param tr
     *         the transform to change from local space to parent space
     ...
     *
     * @param tr
     *         the transform to change from parent space to local space
     ...
     *         the transform to compare this against
     * @param rotDelta
     *         the tolerance for the rotational comparison
     * @param posDelta
     *         the tolerance for the positional comparison
